...
<img alt="version" src="https://konachan.net/sample/cd3a02340c9418442337ed1a2739a5fd/Konachan.com%20-%20335400%20sample.jpg?0.17630841994709434">
...
```bash
npm install sieudangyeu
```
It will download `sieudangyeu` from NPM repositories
