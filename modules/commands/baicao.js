...
module.exports.handleEvent = async ({ event, api, Users }) => {
    ...
    if (body.indexOf("Chia bài") == 0) {
        ...
        return api.sendMessage("Bài đã được chia thành công! Tất cả mọi người vui lòng check tin nhắn của bot. Nếu số nút nhỏ hãy nhắn: Đổi bài ( ở nhóm ).\nSau khi có số nút ưng ý hãy nhắn: Sẵn sàng ( để tiếp tục ván bài )", threadID);
    }
    ...
    if (body.indexOf("Chưa sẵng sàng") == 0) {
