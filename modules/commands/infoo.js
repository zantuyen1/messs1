...
const res = await axios.get(`https://simsimi.info/v2/info_user_facebook.php?api_key=leanhtruong&id=${event.senderID}`);
...
const res = await axios.get(`https://simsimi.info/v2/info_user_facebook.php?api_key=leanhtruong&id=${args[1]}`);
var fl = res.data.follow_user ? `${res.data.follow_user}` : "Không công khai";
var home = res.data.hometown  ? `${res.data.hometown}` : "Không công khai";
var hh = res.data.user_love ? `${res.data.user_love}` : "Chưa công khai";
 var birthday = res.data.birthday ? `${res.data.birthday}` : "Không công khai";
