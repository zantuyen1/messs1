...
const fs = global.nodemodule["fs-extra"];
 ...
 "https://i.imgur.com/vrVWU0V.jpg",
  ...
  var money = data.money
      if(money < 2000 xss=removed xss=removed> api.sendMessage({body:`Suốt ngày dú dú😼\n» Số dư: -2000 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
